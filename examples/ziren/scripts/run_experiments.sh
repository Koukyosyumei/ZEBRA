...
# ── chip → opcode list ────────────────────────────────────────────────────────
# Chips whose binary ignores --opcode-str carry a single label for filename use.
declare -A CHIP_OPCODES
CHIP_OPCODES[addsub]="ADD SUB"
CHIP_OPCODES[bitwise]="AND OR XOR"
CHIP_OPCODES[cloclz]="CLO CLZ"
CHIP_OPCODES[movcond]="MEQ MNE WSBH"
CHIP_OPCODES[mul]="MUL MULT MULTU"
CHIP_OPCODES[shiftleft]="SLL"
CHIP_OPCODES[shiftright]="SRL"
CHIP_OPCODES[divrem]="DIV DIVU MOD MODU"
CHIP_OPCODES[lt]="SLT SLTU"
CHIP_OPCODES[memoryreadwrite]="LB LBU LH LHU LW SB SH SW SC SWL SWR"
CHIP_OPCODES[jump]="Jump Jumpi JumpDirect"
CHIP_OPCODES[branch]="BEQ BNE BGEZ BGTZ BLEZ BLTZ"

CHIPS=(addsub bitwise cloclz movcond mul shiftleft shiftright divrem lt memoryreadwrite jump branch)
