...
fn final_check(
    ...
    let prev_state = format!(
        "prev_value: [{}, {}, {}, {}]",
        trace.data[0][53], trace.data[0][54], trace.data[0][55], trace.data[0][56],
    );
    let op_b_access = format!(
        "value: [{}, {}, {}, {}]",
        trace.data[0][8], trace.data[0][9], trace.data[0][10], trace.data[0][11],
    );
    let op_c_access = format!(
        "value: [{}, {}, {}, {}]",
        trace.data[0][12], trace.data[0][13], trace.data[0][14], trace.data[0][15],
    );
...
pub fn target_program(pc_start: u32, pc_base: u32) -> Program {
    let instructions = vec![
        ...
        Instruction::new(Opcode::SWR, 29, 0, 0x27654320, false, true),
