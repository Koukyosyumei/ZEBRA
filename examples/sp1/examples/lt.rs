...
use sp1_core_machine::alu::LtCols;
use sp1_core_machine::alu::NUM_LT_COLS;
use sp1_core_machine::riscv::LtChip;
...
fn main() -> Result<(), io::Error> {
    ...
    let (mut constraint_info, general_lookup_info) =
        extract_constraints_and_range::<BabyBear, LtChip>(&air, NUM_LT_COLS, prime, args.method == "bb" && !args.no_simplify);
