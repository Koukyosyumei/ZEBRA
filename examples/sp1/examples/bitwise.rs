...
use sp1_core_machine::alu::NUM_BITWISE_COLS;
...
fn main() -> Result<(), io::Error> {
    ...
    let (mut constraint_info, general_lookup_info) =
        extract_constraints_and_range::<BabyBear, BitwiseChip>(&air, NUM_BITWISE_COLS, prime, args.method == "bb" && !args.no_simplify);
    ...
    if args.sparsity {
        print_all_sparsity_reports(&[("Bitwise", &constraint_info)]);
        return Ok(());
    }
